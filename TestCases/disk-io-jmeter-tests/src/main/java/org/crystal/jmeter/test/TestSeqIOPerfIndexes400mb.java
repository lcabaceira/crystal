...
public class TestSeqIOPerfIndexes400mb implements JavaSamplerClient {
    private static final Logger logger = LoggingManager.getLoggerForClass();
    public static final int PAGE_SIZE = 1024 * 4;
    public static final long FILE_SIZE = PAGE_SIZE * 2000L * 50L;
    public static final String FILE_NAME = "testIndexesIO400mb.dat";
    ...
    public static final String OUTPUT_JSON_FILE_NAME = "IoResultsIndexes400mb.json";
