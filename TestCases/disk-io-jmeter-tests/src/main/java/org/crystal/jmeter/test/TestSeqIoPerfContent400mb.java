...
public class TestSeqIoPerfContent400mb implements JavaSamplerClient {
    private static final Logger logger = LoggingManager.getLoggerForClass();
    public static final int PAGE_SIZE = 1024 * 4;
    public static final long FILE_SIZE = PAGE_SIZE * 2000L * 50L;
    public static final String FILE_NAME = "TestContentIO400mb.dat";
    public static final byte[] BLANK_PAGE = new byte[PAGE_SIZE];
    public static  String contentFileSystemPath = "";
    public static  String resultsDirectory = "";
    private static JSONObject resultObj = new JSONObject();
    public static final String OUTPUT_JSON_FILE_NAME = "IoResultsContent400mb.json";
    ...
    private static void preallocateTestFile(final String fileName)
            throws Exception
    {
        // Create the file on the Content Store Disk and pre-allocate size
        RandomAccessFile file = new RandomAccessFile(contentFileSystemPath + "/" + fileName, "rw");
    ...
    public SampleResult runTest(JavaSamplerContext runTestContext) {
        String contentFileSystemPath = runTestContext.getParameter("contentfilesystem.path");


        String timeStamp = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss").format(Calendar.getInstance().getTime());
        resultObj.put("Date and Execution Time", timeStamp);

        resultObj.put("Execution Plan", "Sequential Performance of Content Store FS");
        try {
        ...
        try{
            ...
            deleteFile(contentFileSystemPath + "/" + FILE_NAME);
            ...
            logger.info("Successfully Tested Content Disk IO  at path: " + contentFileSystemPath);
            result.setResponseMessage("Successfully Tested IO at Content Store Disk");
    ...
    public void setupTest(JavaSamplerContext setupContext) {
        contentFileSystemPath = setupContext.getParameter("contentfilesystem.path");
