...
public class TestSeqIoPerfContent8gb implements JavaSamplerClient {
    private static final Logger logger = LoggingManager.getLoggerForClass();
    public static final int PAGE_SIZE = 1024 * 4;
    public static final long FILE_SIZE = PAGE_SIZE * 2000L * 1000L;
    public static final String FILE_NAME = "TestContentIO8gb.dat";
    ...
    public static final String OUTPUT_JSON_FILE_NAME = "IoResultsContent8gb.json";
