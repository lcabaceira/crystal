package org.alfresco.consulting.benchmark.locator;

import org.alfresco.consulting.benchmark.locator.exceptions.PropertiesLocatorException;
...
public final class PropertiesLocator
{
   ...
   private static final String DEFAULT_FILE = "systemtester.properties";
