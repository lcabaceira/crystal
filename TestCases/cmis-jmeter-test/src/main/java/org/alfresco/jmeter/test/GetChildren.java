...
public class GetChildren implements JavaSamplerClient{
	...
	public SampleResult runTest(JavaSamplerContext runTestContext) {
		...
		try{
	        ...
	        result.setResponseMessage("Successfully retrieved cmis folder children.");
            ...
            result.setResponseMessage("Failed to retrieved cmis folder children: " + e);
