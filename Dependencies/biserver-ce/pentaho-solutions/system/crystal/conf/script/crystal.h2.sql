...
DROP TABLE IF EXISTS CRYSTAL.DM_FACT_EXECUTION_PLANS;
...
CREATE TABLE CRYSTAL.STG_JMETER_REPORTS_JSON (
 CONTENT VARCHAR(2000000),
 FILENAME VARCHAR(4096),
 TYPE VARCHAR(128)
);

CREATE TABLE CRYSTAL.OPE_JMETER_EXECUTION_PLAN (
 HOSTNAME VARCHAR(4096) NOT NULL,
 DATETIME TIMESTAMP NOT NULL,
 TESTNAME VARCHAR(4096) NOT NULL,
 MEMORYMAPPEDFILE BIGINT NOT NULL,
 RANDOMACCESSFILE BIGINT NOT NULL,
 BUFFEREDSTREAMFILE BIGINT NOT NULL,
 BUFFEREDCHANNELFILE BIGINT NOT NULL,
...
CREATE TABLE CRYSTAL.DM_FACT_EXECUTION_PLANS (
 ...
 MEMORY_MAPPED_FILE BIGINT DEFAULT 0,
 RANDOM_ACCESS_FILE BIGINT DEFAULT 0,
 BUFFERED_STREAM_FILE BIGINT DEFAULT 0,
 BUFFERED_CHANNEL_FILE BIGINT DEFAULT 0
);

ALTER TABLE CRYSTAL.DM_FACT_EXECUTION_PLANS ADD FOREIGN KEY (TEST_ID) REFERENCES CRYSTAL.DM_DIM_TESTS(ID);
ALTER TABLE CRYSTAL.DM_FACT_EXECUTION_PLANS ADD FOREIGN KEY (TYPE_ID) REFERENCES CRYSTAL.DM_DIM_TYPES(ID);
ALTER TABLE CRYSTAL.DM_FACT_EXECUTION_PLANS ADD FOREIGN KEY (HOSTNAME_ID) REFERENCES CRYSTAL.DM_DIM_HOSTS(ID);
ALTER TABLE CRYSTAL.DM_FACT_EXECUTION_PLANS ADD FOREIGN KEY (DAY_ID) REFERENCES CRYSTAL.DM_DIM_DAYS(ID);
ALTER TABLE CRYSTAL.DM_FACT_EXECUTION_PLANS ADD FOREIGN KEY (MINUTE_ID) REFERENCES CRYSTAL.DM_DIM_MINUTES(ID);
