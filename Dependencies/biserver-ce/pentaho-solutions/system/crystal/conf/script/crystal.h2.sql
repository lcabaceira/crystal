...
ALTER TABLE CRYSTAL.DM_FACT_LOGS ADD PRIMARY KEY (TESTNAME_ID, HOSTNAME_ID, DAY_ID, MINUTE_ID, SECOND, MILLISECOND);
ALTER TABLE CRYSTAL.DM_FACT_LOGS ADD FOREIGN KEY (TESTNAME_ID) REFERENCES CRYSTAL.DM_DIM_TESTS(ID);
